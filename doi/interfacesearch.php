...
if($dsids == ""){
	...
	$user = $db->get_row_prepared("select * from users where pkey = $1", array($thisuserpkey));
	...
	$datasetrow = $db->get_row_prepared("select * from dataset where strabo_dataset_id=$1 and user_pkey = $2 limit 1", array($dsids, $thisuserpkey));
