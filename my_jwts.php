...
header("Location: /");exit(); //20250515 JMA - No longer needed. New JWT system in place.
...
$rows = $db->get_results_prepared("select * from jwts where user_pkey=$1 order by date desc", array($userpkey));
