...
$row = $db->get_row_prepared("select * from instrument where pkey = $1", array($pkey));
...
$detectors = array();
$detectorrows = $db->get_results_prepared("select * from instrument_detector where instrument_pkey = $1", array($pkey));
