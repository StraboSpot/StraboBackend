...
if($p == "FwUk4wQF9dwumR2p8"){
	...
	$db->prepare_query("INSERT INTO micro_installs (ip, version, longitude, latitude, country, region, email) VALUES ($1, $2, $3, $4, $5, $6, $7)",
		array($ip, $ver, $longitude, $latitude, $country, $region, $email));
