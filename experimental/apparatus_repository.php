...
institute,
department,
(SELECT count(*) FROM apprepo.facility_users WHERE users_pkey = $1 AND facility_pkey = i.pkey) AS admincount
...
<?php
	...
	<?php
		...
		$arows = $db->get_results_prepared("SELECT * FROM apprepo.apparatus WHERE facility_pkey = $1 ORDER BY name", array($irow->facility_pkey));
